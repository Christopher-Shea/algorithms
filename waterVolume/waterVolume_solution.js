...
// O(n) -> 2 passes
// Similar to n^2 solution in theory, but makes use of two additional arrays to find the total in 2 sweeps of the input array
function volume (heights) {
...
function volume (heights) {
  ...
  // as before, will keep track of the highest point found while moving through array
  let maxIndex = start;
  ...
  // we know that the maxIndex is a local maximum, no water can be collected at that point
  for (let i = maxIndex + 1; i <= end; i++) {
    ...
    if (currentHeight >= maxHeight) {
      ...
      // add a potential water unit for each spot between the current height and the maximum
...
console.log(volume([1, 2, 4, 5])); // 0
console.log(volume([2, 4, 4, 4, 2, 1])); // 0
console.log(volume([2, 4, 5, 2, 1])); // 0
console.log(volume([5, 4, 3, 2, 1, 0])); // 0
console.log(volume([2, 0, 2])); // 2
console.log(volume([3, 2, 1, 2, 3])); // 4
console.log(volume([0, 3, 2, 0, 1, 0, 2, 0, 1, 0])); // 6
console.log(volume([0, 1, 2, 3, 4, 3, 4, 3])); // 1
console.log(volume([6, 0, 2, 0, 1, 0, 3, 0, 2, 0, 1])); // 15
console.log(volume([1, 3, 2, 4, 1, 2, 0, 3, 2, 4, 2, 1, 0, 2, 0, 4])); // 28
console.log(volume([2, 3, 0, 1, 2, 3, 4, 1, 2, 3, 0, 7, 6, 5, 3, 6, 5, 4, 0, 3, 5, 4, 4, 3, 4, 1, 3, 2])); // 31
console.log(volume([1, 0, 4, 0, 2, 1, 0, 3, 2, 1, 0, 1, 2, 3, 8, 0, 9, 0, 1, 2, 0, 2, 1, 5, 4, 3, 6, 0, 2, 1, 2])); // 77